...
function setActive(parent, newActiveNode, state2) {
  ...
  if (!newActiveNode) {
    (_a = state2.activeState) == null ? void 0 : _a.parent.el.setAttribute("aria-activedescendant", "");
...
function handleParentKeydown(data, state2) {
  var _a;
  const activeDescendant = (_a = state2.activeState) == null ? void 0 : _a.node;
...
function handleEnd3(state2) {
  ...
  removeClass(
    state2.draggedNodes.map((x) => x.el),
    (_c = (_b = state2.initialParent.data) == null ? void 0 : _b.config) == null ? void 0 : _c.longPressClass
  );
  removeClass(
    state2.draggedNodes.map((x) => x.el),
    isSynth ? state2.initialParent.data.config.synthDragPlaceholderClass : (_e = (_d = state2.initialParent.data) == null ? void 0 : _d.config) == null ? void 0 : _e.dragPlaceholderClass
  );
  ...
  resetState();
  state2.selectedState = void 0;
  (_f = config == null ? void 0 : config.onDragend) == null ? void 0 : _f.call(config, {
    parent: state2.currentParent,
    values: parentValues(state2.currentParent.el, state2.currentParent.data),
    draggedNode: state2.draggedNode,
    draggedNodes: state2.draggedNodes,
...
function pointermoveClasses(state2, config) {
  if (config.longPressClass)
    removeClass(
      state2.draggedNodes.map((x) => x.el),
      config == null ? void 0 : config.longPressClass
    );
}
...
//# sourceMappingURL=@formkit_drag-and-drop_react.js.map
